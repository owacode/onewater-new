...
export class RecoverPasswordComponent implements OnInit {
  ...
  reset() {
    ...
    if(this.decoded_token.platform == 'blog_author') {
      this.http.post<{status: string, msg: string, result: any}>('https://onewateracademy.org/api/blog/update-password',this.resetpassword.value)
      .subscribe(result=> {
        //console.log(result);
        this.modal.hideBtnLoader()
      ...
      this.http.post<{status: string, msg: string, result: any}>('https://onewateracademy.org/api/instructor/update-password',this.resetpassword.value)
      .subscribe(result=> {
        //console.log(result);
        this.modal.hideBtnLoader();
        this.modal.openModal('#passSuccessModal');
